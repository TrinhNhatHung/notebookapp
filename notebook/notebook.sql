...
--
-- Host: 127.0.0.1    Database: notebookapp
-- ------------------------------------------------------
...
INSERT INTO `normaluser` VALUES (1,'qwert12345','12345qwert');
...
CREATE TABLE `note` (
  ...
  `emailuser_id` int DEFAULT NULL,
  `normaluser_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_note_emailuser_idx` (`emailuser_id`),
  KEY `fk_note_normalemail1_idx` (`normaluser_id`),
  CONSTRAINT `fk_note_emailuser` FOREIGN KEY (`emailuser_id`) REFERENCES `emailuser` (`id`),
  CONSTRAINT `fk_note_normalemail1` FOREIGN KEY (`normaluser_id`) REFERENCES `normaluser` (`id`)
...
-- Dump completed on 2020-08-28 22:22:13
